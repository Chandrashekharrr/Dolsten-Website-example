    ...
    return(
        ...
        <div className="mainAwards w-full px-5">
            ...
            <div className="awardMAin flex py-5">
                ...
                <div className="awardPhoto relative basis-1/4">
                    <Image src="/award1.webp" alt=""  width={290} height={190}/>
                </div>
        ...
        <div className="mainAwards w-full px-5">
            ...
            <div className="awardMAin flex py-5">
                ...
                <div className="awardPhoto relative basis-1/4">
                    <Image src="/award2.webp" alt="" width={290} height={190}/>
                </div>
        ...
        <div className="mainAwards w-full px-5">
            ...
            <div className="awardMAin flex py-5">
                ...
                <div className="awardPhoto relative basis-1/4">
                    <Image src="/award3.webp" alt="" width={290} height={190}/>
                </div>
        ...
        <div className="mainAwards w-full px-5">
            ...
            <div className="awardMAin flex py-5">
                ...
                <div className="awardPhoto relative basis-1/4">
                    <Image src="/award4.webp" alt="" width={290} height={190}/>
                </div>
