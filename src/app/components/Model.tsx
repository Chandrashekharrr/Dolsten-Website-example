                    ...
                    <div className="wrappermini  flex flex-col w-full  h-full">
                        ...
                        <div className="colOne  w-full px-5">
                            <div className="whiteSpace w-full bg-white p-4 flex flex-col sm:flex-row lg:flex-col justify-between items-center sm:gap-10">
                                ...
                                <div className="imageDiv overflow-hidden"><Image src="./model1.webp" alt="" className="object-cover " width={500} height={400} /></div>
                    ...
                    <div className="wrappermini  flex flex-col w-full  h-full">
                        ...
                        <div className="colOne  w-full px-5">
                            <div className="whiteSpace w-full bg-white p-4 flex flex-col sm:flex-row lg:flex-col justify-between items-center sm:gap-10">
                                ...
                                <div className="imageDiv overflow-hidden"><Image src="./model2.webp" alt="" className="object-cover " width={500} height={400} /></div>
                     ...
                     <div className="wrappermini  flex flex-col w-full  h-full">
                        ...
                        <div className="colOne  w-full px-5">
                            <div className="whiteSpace w-full bg-white p-4 flex flex-col sm:flex-row lg:flex-col justify-between items-center sm:gap-10">
                                ...
                                <div className="imageDiv overflow-hidden"><Image src="./model3.webp" alt="" className="object-cover "  width={500} height={400}/></div>
                     ...
                     <div className="wrappermini  flex flex-col w-full  h-full">
                        ...
                        <div className="colOne  w-full px-5">
                            <div className="whiteSpace w-full bg-white p-4 flex flex-col sm:flex-row lg:flex-col justify-between items-center sm:gap-10">
                                ...
                                <div className="imageDiv overflow-hidden"><Image src="./model4.webp" alt="" className="object-cover " width={500} height={400} /></div>
